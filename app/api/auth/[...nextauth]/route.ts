...
// Get environment variables (optional for Google OAuth)
...
// Build providers array conditionally - include Google only if credentials are available
const providers: NextAuthOptions['providers'] = googleClientId && googleClientSecret
  ? [
      GoogleProvider({
